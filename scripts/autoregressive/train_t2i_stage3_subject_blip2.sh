...
experiment_name="checkpoints/llamagen_t2i_stage3_subject_blip2_train_all_subject_w_flux_segment"
...
data_path="/home/jovyan/MLLMG/jsonl_dir/subject_ti2i_stage1_w_flux_segment.jsonl"
...
--epochs 5 \
--subject_driven \
--reference_data_path /home/jovyan/MLLMG/reference.jsonl \
