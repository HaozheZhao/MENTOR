...
experiment_name="checkpoint/LLava_just_segment_pretrain_stage3_multiobjects_many_objects_segmentation_bbox_filtered_objects_4mask_1280_context_from_stage1"
...
--gpt-ckpt /tmp/haozhezhao/MLLMG_ckpts/checkpoints/AfterI2I_llavat5_subject_train_all_T5_subject_t2i_ti2i_120_w_flux_segment_noimageonly_empty_fix_train_all/0100000.pt \
# --resume \
