...
experiment_name="checkpoints/llamagen_t2i_stage3_subject_instructblip_train_all_subject_t2i_ti2i_120_w_flux_segment"
# model_name_or_path="/nobackup/zefan/projects/VLGen/model/blip2-flan-t5-xl"
model_name_or_path="model/instructblip-flan-t5-xl"
...
load_from_checkpoint="model/llamagen_t2i/t2i_XL_stage2_512.pt"
