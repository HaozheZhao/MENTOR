...
experiment_name="checkpoint/EmptyFix_InstructBlip_just_segment_pretrain_stage3_multiobjects_many_objects_segmentation_bbox_objects"

experiment_name="checkpoint/EmptyFix_InstructBlip_just_segment_pretrain_from_stage1_multiobjects_many_objects_segmentation_bbox_filtered_objects"

experiment_name="checkpoint/LLava_just_segment_pretrain_stage3_multiobjects_many_objects_segmentation_bbox_filtered_objects_4mask_1280_context"

experiment_name="checkpoint/LLava_just_segment_pretrain_stage3_multiobjects_many_objects_segmentation_bbox_filtered_objects_4mask_1280_context_mix_with_stage2_data"

experiment_name="checkpoint/FromStage1_LLava_just_segment_pretrain_stage3_multiobjects_many_objects_segmentation_bbox_filtered_objects_3mask_888_context_mix_with_stage2_data"

experiment_name="checkpoint//X2I_Filtered_data_train_600k_recap_paser_train_mix_100ksub_100kt2i_100k_recover_1024_context"
...
data_path="/tmp/haozhezhao/MLLMG/jsonl_data/multiobjects_molom_imagenet_flux_qwen_midsource_gen_2_2m_trained.jsonl"
data_path="/tmp/haozhezhao/MLLMG/jsonl_data/merged_train_set_set_subject_400k_recap_t2i_400k_flux_200k_midjourney_150k_recovery_150k_grounding_100fluxseg_50samseg_200k_3_mask.jsonl"


data_path="/tmp/haozhezhao/MLLMG/jsonl_data/multiobjects_molom_imagenet_flux_qwen_midsource_cc12m_gen_trained_raw_cleaned.jsonl"
data_path="/tmp/haozhezhao/MLLMG/jsonl_data/multiobjects_molom_imagenet_flux_qwen_midsource_cc12m_gen_trained_raw_cleaned_four_mask.jsonl"
data_path="/tmp/haozhezhao/MLLMG/jsonl_data/multiobjects_molom_imagenet_flux_qwen_midsource_cc12m_gen_trained_raw_newclean_four_mask.jsonl"
data_path="/tmp/haozhezhao/MLLMG/jsonl_data/mix_for_mask_stage2_data_trained.jsonl"

data_path="/tmp/haozhezhao/MLLMG/jsonl_data/X2I_Filtered_data_train_600k_recap_paser_train_mix_100ksub_100kt2i_100k_recover.jsonl"
...
val_data_path="/tmp/haozhezhao/MLLMG/jsonl_data/multiobjects_molom_imagenet_flux_qwen_midsource_gen_val.jsonl"
val_data_path="/tmp/haozhezhao/MLLMG/jsonl_data/multiobjects_molom_imagenet_flux_qwen_midsource_cc12m_gen_val_raw_cleaned.jsonl"
val_data_path="/tmp/haozhezhao/MLLMG/jsonl_data/multiobjects_molom_imagenet_flux_qwen_midsource_cc12m_gen_val_raw_cleaned_four_mask.jsonl"
val_data_path="/tmp/haozhezhao/MLLMG/jsonl_data/multiobjects_molom_imagenet_flux_qwen_midsource_cc12m_gen_val_all_raw_newclean_four_mask.jsonl"
val_data_path="/tmp/haozhezhao/MLLMG/jsonl_data/multiobject_val_merge_with_dreambenchplus.jsonl"

val_data_path="/tmp/haozhezhao/MLLMG/jsonl_data/X2I_Filtered_data_train_600k_recap_paser_val.jsonl"
...
--gpt-ckpt /tmp/haozhezhao/MLLMG/checkpoint/X2I_Filtered_data_train_600k_recap_paser_train_mix_100ksub_100kt2i_100k_recover_1024_context/003-GPT-XL/checkpoints/0012000.pt \
--resume \
# --dreambench_eval \


# --gpt-ckpt /tmp/haozhezhao/MLLMG/checkpoint/FromStage1_LLava_just_segment_pretrain_stage3_multiobjects_many_objects_segmentation_bbox_filtered_objects_3mask_888_context_mix_with_stage2_data/003-GPT-XL/checkpoints/0002000.pt \
