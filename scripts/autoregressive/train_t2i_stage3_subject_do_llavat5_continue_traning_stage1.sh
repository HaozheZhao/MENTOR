...
experiment_name="checkpoints/llavat5_subject_continueT2I_mid_flux_3M"
experiment_name="checkpoints/llavat5_subject_continueT2I_mid_flux_3M_ZeroFix"
...
data_path="/tmp/haozhezhao/MLLMG/jsonl_data/continueT2I_mid_flux_2M.jsonl"
...
language_projection="/tmp/haozhezhao/LLaVA/checkpoints/llava-v1.5-flant5_fixed-pretrain/mm_projector.bin"
lr=5e-4
num_workers=4
