...
def main(args):
    ...
    prompts = [
        ...
        # "A photo of a cat with a hat and a bow tie.",
        # "A happy dog with a red ball in its mouth.",
        " Under the bright sun, dinosaurs strolling in Times Square, with people taking photos and traffic passing by",
        " A DIY cage for my guinea pigs",
    ]
    ...
    save_image(samples, "test_sample_cfg_{}_topk_{}.png".format(args.cfg_scale, args.top_k), nrow=8, normalize=True, value_range=(-1, 1))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--t5-path", type=str, default='/home/haozhezhao/model/')
    parser.add_argument("--t5-model-type", type=str, default='flan-t5-xl')
    parser.add_argument("--t5-feature-max-len", type=int, default=120)
    parser.add_argument("--t5-feature-dim", type=int, default=2048)
    parser.add_argument("--no-left-padding", action='store_true', default=False)
    parser.add_argument("--gpt-model", type=str, choices=list(GPT_models.keys()), default="GPT-XL")
    parser.add_argument("--gpt-ckpt", type=str, default="/home/haozhezhao/model/llamagen/t2i_XL_stage2_512.pt")
    ...
    parser.add_argument("--vq-ckpt", type=str, default="/home/haozhezhao/model/llamagen/vq_ds16_t2i.pt", help="ckpt path for vq model")
    ...
    parser.add_argument("--use_vision_tower", action='store_true', default=False)
